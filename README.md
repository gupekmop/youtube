...
#### 14.10.2021
- Исправлен переход на некоторые каналы из поиска и другие мелочи

#### 29.06.2021
- Если не находит видео через javascript (клиентом), то ищет через php (сервером, для этого youtube.php должен иметь доступ до внешнего интернета)